...
# $1 = org name e.g., 5bloques | seradpa
...
if [ "$1" == "utest" ]; then
    ...
    # Set the org context to 5bloques
    set_test_case   "Test set_org_context for '5bloques'"
    set_org_context "5bloques"
    assert_equal    "5bloques"  $ORGANIZATION_CONTEXT

    # Set the org context to 5bloques
    set_test_case   "Test set_org_context for 'seradpa'"
    set_org_context "seradpa"
    assert_equal    "seradpa"  $ORGANIZATION_CONTEXT
